function Footer() {
  return (
    <div className="fixed bottom-3 right-3 w-auto flex items-center gap-2 py-2 px-3 bg-card border border-border rounded-full text-muted-foreground text-xs z-50 backdrop-blur">
